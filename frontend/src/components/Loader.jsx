    ...
    <div className="loader-wrapper">
      ...
      <svg aria-label="loader being flipped clockwise and circled by three white curves fading in and out" role="img" height="56px" width="56px" viewBox="0 0 56 56" className="loader">
        ...
        <g transform="translate(2,2)">
          <g transform="rotate(-90,26,26)" strokeLinecap="round" strokeDashoffset="153.94" strokeDasharray="153.94 153.94" stroke="#4f46e5" fill="none">
          ...
          <g transform="translate(13.75,9.25)" className="loader__model">
            <path d="M 1.5 2 L 23 2 C 23 2 22.5 8.5 19 12 C 16 15.5 13.5 13.5 13.5 16.75 C 13.5 20 16 18 19 21.5 C 22.5 25 23 31.5 23 31.5 L 1.5 31.5 C 1.5 31.5 2 25 5.5 21.5 C 8.5 18 11 20 11 16.75 C 11 13.5 8.5 15.5 5.5 12 C 2 8.5 1.5 2 1.5 2 Z" fill="#6366f1" />
            <g strokeLinecap="round" stroke="#e0e7ff">
              ...
              <line y2="31.5" x2={12} y1={16} x1={12} strokeDasharray="1 107" strokeWidth={1} stroke="#c7d2fe" className="loader__sand-line-left" />
              <line y2="31.5" x2="12.5" y1={16} x1="12.5" strokeDasharray="12 96" strokeWidth={1} stroke="#c7d2fe" className="loader__sand-line-right" />
              <g strokeWidth={0} fill="#e0e7ff">
            ...
            <rect height={2} width="24.5" fill="#4338ca" />
            <rect height={1} width="19.5" y="0.5" x="2.5" ry="0.5" rx="0.5" fill="#4f46e5" />
            <rect height={2} width="24.5" y="31.5" fill="#4338ca" />
            <rect height={1} width="19.5" y={32} x="2.5" ry="0.5" rx="0.5" fill="#4f46e5" />
          </g>
        </g>
      </svg>
    </div>
