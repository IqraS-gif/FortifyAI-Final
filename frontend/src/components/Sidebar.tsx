...
export default function Sidebar() {
  ...
  return (
    <aside className="w-16 sm:w-20 bg-white border-r border-slate-200/80 min-h-screen flex flex-col items-center justify-between py-5 shrink-0 z-40">
      {/* Top Logo */}
      ...
      <div className="flex flex-col items-center gap-4">
        ...
        {/* Profile Avatar */}
        <div className="w-10 h-10 rounded-full bg-blue-100 text-blue-700 font-bold text-xs flex items-center justify-center border border-blue-200 shadow-xs">
          AA
        </div>
      </div>
    </aside>
